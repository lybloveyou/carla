...
////////////////////////////////////////////////////////////////////////////////
// Allow re-import if metadata exists
bool URoadRunnerReimportFactory::CanReimport(UObject * obj, TArray<FString>& outFilenames)
{
	...
	// Search for metadata file at original import location
...
EReimportResult::Type URoadRunnerReimportFactory::Reimport(UObject * obj)
{
	...
	// Prevent this from being garbage collected
	this->AddToRoot();
...
#else // 4.26+
	assetRegistryModule.Get().GetReferencers(assetId, refNames, UE::AssetRegistry::EDependencyCategory::Package);
#endif
